      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarMenuBadge</span>
            <span className="text-sm text-muted-foreground">The tabular count badge on the "Matches" row — 12 matches this season.</span>
