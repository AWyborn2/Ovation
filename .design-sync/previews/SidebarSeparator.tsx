      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarSeparator</span>
            <span className="text-sm text-muted-foreground">The thin dividers between the header, nav groups and footer.</span>
