...
export function ClubAdminSidebar() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <span className="text-sm text-muted-foreground">The sidebar surface itself — header, searchable nav groups, footer user row and edge rail, rendered with collapsible="none".</span>
