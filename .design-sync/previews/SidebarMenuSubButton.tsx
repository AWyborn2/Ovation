...
export function SubmenuButtons() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarMenuSubButton</span>
            <span className="text-sm text-muted-foreground">The compact link buttons inside the Statistics submenu — "Batting" shown active.</span>
