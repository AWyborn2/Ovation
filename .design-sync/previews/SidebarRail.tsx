...
export function DesktopRailSidebar() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarRail</span>
            <span className="text-sm text-muted-foreground">The desktop-variant sidebar with the edge rail — a hover-reveal resize/toggle strip along the sidebar's right edge (invisible until hovered).</span>
