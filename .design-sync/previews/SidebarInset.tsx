...
export function ContentPaneInset() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarInset</span>
            <span className="text-sm text-muted-foreground">The main content pane beside the sidebar — carries the page header with the trigger and this content area.</span>
