      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        <Sidebar collapsible="none" style={{ position: "relative", height: "100%", background: "transparent" }}>
          <SidebarHeader>
            ...
            <SidebarInput placeholder="Search players…" defaultValue="fletcher" />
          </SidebarHeader>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarInput</span>
            <span className="text-sm text-muted-foreground">The compact search field in the sidebar header, shown here with a typed query.</span>
