      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarProvider</span>
            <span className="text-sm text-muted-foreground">Provider supplying open/collapsed state and context to the whole shell — every sidebar part below lives inside it.</span>
