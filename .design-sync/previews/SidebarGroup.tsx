...
export function SeasonNavGroup() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarGroup</span>
            <span className="text-sm text-muted-foreground">A bounded nav section — the "Season" group wraps its label, corner action and menu.</span>
