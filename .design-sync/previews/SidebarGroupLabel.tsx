...
export function GroupLabelsInContext() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarGroupLabel</span>
            <span className="text-sm text-muted-foreground">The muted uppercase-style section labels — "Season" and "Honour boards".</span>
