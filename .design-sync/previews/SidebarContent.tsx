...
export function NavContentRegion() {
  return (
    <div
      style={{
        width: 720,
      ...
      <SidebarProvider style={{ minHeight: 0, height: "100%" }}>
        ...
        <SidebarInset style={{ minHeight: 0 }}>
          ...
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 6 }}>
            <span className="text-sm font-semibold">SidebarContent</span>
            <span className="text-sm text-muted-foreground">The scrollable middle region of the sidebar holding the Season and Honour boards nav groups.</span>
