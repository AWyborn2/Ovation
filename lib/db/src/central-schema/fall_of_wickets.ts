 ...
 */
export const centralFallOfWicketsTable = centralSchema.table("fall_of_wickets", {
...
export type CentralFallOfWicketRow = typeof centralFallOfWicketsTable.$inferSelect;
