 ...
 */
export const centralClubNameHistoryTable = centralSchema.table("club_name_history", {
...
export type CentralClubNameHistoryRow = typeof centralClubNameHistoryTable.$inferSelect;
