 ...
 */
export const matchPlayerLinesTable = pgTable(
  "match_player_lines",
  {
  ...
  (t) => ({
    idxMatch: index("match_player_lines_match_idx").on(t.matchId),
    idxPlayer: index("match_player_lines_player_idx").on(t.playerId),
  }),
);
