...
export const playerGradeSeasonStatsTable = pgTable(
  ...
  (t) => ({
    idxPlayer: index("pgss_player_idx").on(t.playerId),
    idxGradeSeason: index("pgss_grade_season_idx").on(t.grade, t.season),
  }),
);

export const insertPlayerGradeSeasonStatSchema = createInsertSchema(
