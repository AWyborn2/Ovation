 ...
 */
export const awardVotingConfigTable = pgTable(
  "award_voting_config",
  {
  ...
  (t) => ({
    uqAwardSeason: unique("award_voting_config_award_season_unique").on(t.awardId, t.season),
  }),
);
 ...
 * `ensure-constraints`.
 */
export const awardBallotsTable = pgTable(
  "award_ballots",
  {
    id: serial("id").primaryKey(),
  ...
  (t) => ({
    uqBallot: unique("award_ballots_config_captain_grade_round_unique").on(
      t.configId,
      t.captainId,
      t.grade,
      t.round,
