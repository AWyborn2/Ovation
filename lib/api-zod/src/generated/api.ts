...
export const AddPlayerImageResponse = zod.object({
  "id": zod.number(),
  "playerId": zod.number(),
  "imageUrl": zod.string(),
  "sortOrder": zod.number(),
...
export const DeletePlayerImageResponse = zod.void()
...
export const GetMatchResponse = zod.object({
  ...
  "badgeStyle": zod.enum(['shield', 'ball', 'chevron', 'pill']).optional().describe('Grade badge visual preset. Defaults to \"shield\" when unset.')
...
export const CreateStatResponse = zod.object({
  "id": zod.number(),
  "playerId": zod.number(),
  "surname": zod.string(),
  "givenName": zod.string(),
...
export const DeleteStatResponse = zod.void()
 ...
 */
export const GetGradeMetaResponseItem = zod.object({
  "grade": zod.string(),
  "abbr": zod.string(),
  "sortOrder": zod.number()
}).describe('Display metadata for a single grade — canonical name, badge abbreviation, and seniority sort order.')
export const GetGradeMetaResponse = zod.array(GetGradeMetaResponseItem)
...
export const CreateCapResponse = zod.object({
  "id": zod.number(),
  "capNumber": zod.number(),
  "category": zod.enum(['male', 'female']).describe('Which A Grade cap list this entry belongs to.'),
  "name": zod.string(),
...
export const DeleteCapResponse = zod.void()
...
export const CreateLifeMemberResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "inductionYear": zod.number(),
  "isPlayingMember": zod.boolean(),
...
export const DeleteLifeMemberResponse = zod.void()
...
export const CreatePremiershipResponse = zod.object({
  "id": zod.number(),
  "year": zod.number(),
  "grade": zod.string(),
  "competition": zod.string(),
...
export const DeletePremiershipResponse = zod.void()
...
export const SubmitPasswordResetResponse = zod.void()
 ...
 */
export const CaptainLogoutResponse = zod.void()
...
export const CreateCaptainResponse = zod.object({
  "id": zod.number(),
  "username": zod.string(),
  "displayName": zod.string(),
  "grades": zod.array(zod.string()),
...
export const DeleteCaptainResponse = zod.void()
...
export const DeleteAwardVotingConfigResponse = zod.void()
...
export const DeleteConfigBallotResponse = zod.void()
...
export const DeleteAwardPointsConfigResponse = zod.void()
...
export const CreateHonourBoardResponse = zod.object({
  "id": zod.number(),
  "key": zod.string(),
  "label": zod.string(),
  "title": zod.string(),
...
export const DeleteHonourBoardResponse = zod.void()
...
export const DeleteHonourBoardOverrideResponse = zod.void()
...
export const CreateAwardResponse = zod.object({
  "id": zod.number(),
  "key": zod.string(),
  "title": zod.string(),
  "description": zod.string(),
...
export const DeleteAwardResponse = zod.void()
...
export const CreateAwardWinnerResponse = zod.object({
  "id": zod.number(),
  "awardId": zod.number(),
  "season": zod.number(),
  "playerId": zod.number().nullish(),
...
export const DeleteAwardWinnerResponse = zod.void()
...
export const CreateTeamOfDecadeBoardResponse = zod.object({
  "id": zod.number(),
  "key": zod.string(),
  "title": zod.string(),
  "teamLabel": zod.string(),
...
export const DeleteTeamOfDecadeBoardResponse = zod.void()
...
export const CreateTeamOfDecadeMemberResponse = zod.object({
  "id": zod.number(),
  "boardId": zod.number(),
  "playerId": zod.number().nullish(),
  "name": zod.string(),
...
export const DeleteTeamOfDecadeMemberResponse = zod.void()
...
export const CreateClubRoleResponse = zod.object({
  "id": zod.number(),
  "season": zod.number(),
  "role": zod.string(),
  "grade": zod.string().nullish(),
...
export const DeleteClubRoleResponse = zod.void()
...
export const CreateJuniorOfficeBearerResponse = zod.object({
  "id": zod.number(),
  "season": zod.number(),
  "role": zod.string(),
  "name": zod.string(),
...
export const DeleteJuniorOfficeBearerResponse = zod.void()
...
export const CreateCardThemeResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "bgDark": zod.string(),
  "bgPanel": zod.string(),
...
export const DeleteCardThemeResponse = zod.void()
...
export const CreateCardAudioTrackResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "url": zod.string(),
  "durationMs": zod.number().nullish(),
...
export const DeleteCardAudioTrackResponse = zod.void()
...
export const CreateCardTemplateResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "cardKinds": zod.array(zod.string()),
  "source": zod.enum(['background', 'layers']),
...
export const DeleteCardTemplateResponse = zod.void()
...
export const CreateCardEffectPresetResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "effects": zod.object({
  "tone": zod.enum(['bw', 'duotone']).optional(),
...
export const DeleteCardEffectPresetResponse = zod.void()
...
export const DeleteCardLayoutResponse = zod.void()
...
export const CreateCardSetResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "platformSize": zod.enum(['square', 'portrait', 'story']),
  "slides": zod.array(zod.object({
...
export const DeleteCardSetResponse = zod.void()
...
export const CreateNavItemResponse = zod.object({
  "id": zod.number(),
  "surface": zod.enum(['senior_menu', 'junior_menu', 'junior_quick_links', 'admin_tiles']).describe('Which navigation surface an item belongs to: the senior top menu, the junior top menu, the junior dashboard quick-link cards, or the admin hub tiles.'),
  "label": zod.string().describe('Display label \/ card title.'),
  "description": zod.string().describe('Card description (used by card surfaces only).'),
...
export const DeleteNavItemResponse = zod.void()
...
export const DismissSocialDraftResponse = zod.void()
...
export const GetJuniorMatchResponse = zod.object({
  ...
  "venueSuburb": zod.string().nullish(),
  "status": zod.string().nullish(),
  "opponentName": zod.string().nullish(),
  "hhResult": zod.string().nullish(),
...
export const CreateCardVideoJobResponse = zod.object({
  "id": zod.string(),
...
export const DownloadCardVideoJobResponse = zod.unknown()
...
export const UpdateTenantBrandBody = zod.object({
  ...
  "secondaryColour": zod.string().nullish(),
  "tertiaryColour": zod.string().nullish(),
  "badgeStyle": zod.enum(['shield', 'ball', 'chevron', 'pill']).optional()
...
export const PlatformSignupResponse = zod.object({
  "tenantId": zod.number(),
  "slug": zod.string(),
  "name": zod.string(),
  "redirectUrl": zod.string().describe('The new tenant\'s admin URL to redirect the browser to.')
})
 ...
 */
export const PlatformAdminLogoutResponse = zod.void()
...
export const ProvisionTenantAsAdminResponse = zod.object({
  "id": zod.number(),
  "slug": zod.string(),
  "name": zod.string(),
  "plan": zod.enum(['free', 'club', 'pro']),
...
export const IssueTenantAdminResetResponse = zod.object({
  "resetUrl": zod.string().describe('The single-use link to hand to the club admin out-of-band.'),
  "expiresAt": zod.string().describe('ISO-8601 instant the link stops working.'),
  "username": zod.string(),
  "displayName": zod.string(),
  "tenantName": zod.string(),
  "created": zod.boolean().describe('True when the admin was bootstrapped (did not previously exist).')
})
