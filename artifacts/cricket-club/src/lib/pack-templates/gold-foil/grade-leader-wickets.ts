...
// Metallic Foil — Leading Wicket-Taker. The kind's shared skeleton body (`skeleton-designs.ts`)
...
export const gradeLeaderWickets: PackCardTemplate = {
  ...
  formats: gradeLeaderFormats(FOIL_LOOK, "Wickets", { on: "clubHashtag", off: "hashtags" }),
};
