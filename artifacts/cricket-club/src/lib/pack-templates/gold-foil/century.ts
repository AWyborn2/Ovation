...
// B16 — Century. Hundred — foil runs, balls, opponent & round.
//
...
// ---------------------------------------------------------------------------
// Story (1080×1920) — foil runs, gold-ring photo, foil name + meta line
// ---------------------------------------------------------------------------
...
const storyHtml = storyColumnRoot(
  storyLogo +
    ...
    `<div style="flex:none">` +
    foilText("{{runs}}", 266, ";line-height:.82") +
    `<div style="font:600 17px/1 ui-monospace,Menlo,monospace;letter-spacing:.22em;color:rgba(255,255,255,.62);margin-top:14px">CENTURY</div>` +
    `</div>` +
    // Batter photo drops when empty rather than framing a blank box.
    ...
    `<div style="font:600 16px/1 ui-monospace,Menlo,monospace;letter-spacing:.16em;color:rgba(255,255,255,.55);margin-top:13px">{{balls}} balls · vs {{opponent}} · RD {{round}}</div>` +
    `</div>` +
    `</div>` +
...
const sharedHtml = sharedColumnRoot(
  sharedHeader("CENTURY", "MILESTONE") +
    ...
    `<div style="font:600 20px/1 ui-monospace,Menlo,monospace;letter-spacing:.26em;color:var(--gold,#F5B21A)">RAISED THE BAT</div>` +
    `<div style="font-family:var(--disp,'Anton'),sans-serif;font-size:calc(var(--k,1.4)*160px);line-height:.86;color:var(--gold,#F5B21A);margin-top:calc(var(--k,1.4)*8px)"><span>{{runs}}</span><span style="font-size:calc(var(--k,1.4)*48px);color:rgba(255,255,255,.6)"> ({{balls}})</span></div>` +
