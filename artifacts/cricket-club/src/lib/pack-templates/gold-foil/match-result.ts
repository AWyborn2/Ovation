...
import { clubHeaderFields, logoField, photoField, textField } from "../shared";
import { matchResultFormats } from "../skeleton-designs";
import { FOIL_LOOK } from "./fragments";

// Metallic Foil — Match Result. The kind's shared skeleton body (`skeleton-designs.ts`)
...
export const matchResult: PackCardTemplate = {
  ...
  formats: matchResultFormats(FOIL_LOOK, {
    photo: true,
    footer: { on: "clubHashtag", off: "hashtags" },
  }),
};
