...
export const bigMoment: PackCardTemplate = {
  ...
  fields: [
    ...
    textField("inningsLabel", "Innings label", "HALLS HEAD · 2ND INNINGS"),
    ...
    textField("hashtags", "Hashtag footer", "#HALLSHEAD · LIVE UPDATES"),
    textField("hashtagsExtra", "Secondary footer tag", "LIVE UPDATES"),
    textField("sponsorPresentedBy", "Live scoring sponsor", "eSA Sport"),
  ],
  formats: {
    story: storyHtml,
    shared: sharedHtml,
