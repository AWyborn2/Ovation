      ...
      {isLoading ? (
        ...
        <>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-primary-text">Batting</h2>
          ...
          {/* Bowling */}
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-primary-text">Bowling</h2>
            <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
          ...
          {player.matches.length > 0 && (
            <section className="space-y-2">
              <h2 className="text-lg font-serif font-bold text-primary-text">Match Log</h2>
  ...
  return (
    <section className="space-y-2">
      <div className="flex items-baseline justify-between gap-3">
        <h2 className="text-lg font-serif font-bold text-primary-text">Senior Career</h2>
