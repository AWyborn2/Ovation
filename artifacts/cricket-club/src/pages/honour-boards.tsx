...
type ExtraTab = "caps" | "life-members" | "awards" | "team-of-decade" | "search";
...
export default function HonourBoards() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab !== "search" && activeTab !== "caps" && activeTab !== "life-members" && activeTab !== "awards" && activeTab !== "team-of-decade" && scope === "career" && (
      ...
      {activeTab !== "search" && activeTab !== "caps" && activeTab !== "life-members" && activeTab !== "awards" && activeTab !== "team-of-decade" && (
